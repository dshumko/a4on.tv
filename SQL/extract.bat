...
D:\RDBMS\Firebird\30X\isql localhost:A4ON_DB -o %LOG_DIR%\db.isql.sql -x -u SYSDBA -p masterkey -ch UTF8
D:\RDBMS\Firebird\IBExpert\IBEScript.exe %LOG_DIR%\extract.ibeblock
