    ...
    object cbRegular: TDBComboBoxEh
      ...
      KeyItems.Strings = (
        ...
        '(\s*)?(\+)?([- _():=+]?\d[- _():=+]?){10,14}(\s*)'
          ...
          '(([0-9A-Za-z]{1}[-0-9A-z\.]*[0-9A-Za-z]{1})|([0-9'#1040'-'#1071#1072'-'#1103']{1}[-0-9' +
          #1040'-'#1103'\.]*[0-9'#1040'-'#1071#1072'-'#1103']{1}))@((([-0-9A-Za-z]+\.){1,2}[-A-Za-z]{2,})|(' +
          '([-0-9'#1040'-'#1071#1072'-'#1103']+\.){1,2}[-'#1040'-'#1071#1072'-'#1103']{2,}))'
