object apgEQGPort: TapgEQGPort
  Left = 0
  Top = 0
  Caption = #1064#1072#1073#1083#1086#1085#1099' '#1087#1086#1088#1090#1086#1074' '#1075#1088#1091#1087#1087#1099' '#1086#1073#1086#1088#1091#1076#1086#1074#1072#1085#1080#1103
  ClientHeight = 253
  ClientWidth = 868
  Color = clBtnFace
  ...
  object dbgPorts: TDBGridEh
    ...
    OnDblClick = dbgPortsDblClick
    OnSortMarkingChanged = dbgPortsSortMarkingChanged
    Columns = <
      item
        CellButtons = <>
        DynProps = <>
