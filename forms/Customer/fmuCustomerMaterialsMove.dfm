object apgCustomerMaterialsMove: TapgCustomerMaterialsMove
  Left = 0
  Top = 0
  Caption = #1052#1072#1090#1077#1088#1080#1072#1083#1099' '#1079#1072#1103#1074#1086#1082' '#1072#1073#1086#1085#1077#1085#1090#1072
  ClientHeight = 211
  ClientWidth = 779
  Color = clBtnFace
  ...
  object dsMat: TpFIBDataSet
    SelectSQL.Strings = (
      ...
      '      from REQUEST R'
        ...
        'M.RQ_ID)'
      '      where R.Rq_Customer = :CUSTOMER_ID) NM'
