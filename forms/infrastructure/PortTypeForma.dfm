inherited PortTypeForm: TPortTypeForm
  Left = 381
  Top = 171
  ...
  object dsType: TpFIBDataSet
    UpdateSQL.Strings = (
        ...
        'execute procedure Objects_Iud(1, 57, :O_ID, :O_Name, :O_Descript' +
        'ion, :O_DIMENSION, 0, :O_CHARFIELD)')
    DeleteSQL.Strings = (
      'execute procedure Objects_Iud(2, 57, :OLD_O_ID)')
    InsertSQL.Strings = (
      
        'execute procedure Objects_Iud(0, 57, :O_ID, :O_Name, :O_Descript' +
        'ion, :O_DIMENSION, 0, :O_CHARFIELD)')
    RefreshSQL.Strings = (
      'select'
      '    o.O_ID'
