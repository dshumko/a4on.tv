inherited BCIssuesSolutionForm: TBCIssuesSolutionForm
  Caption = #1056#1077#1096#1077#1085#1080#1077' '#1087#1088#1086#1073#1083#1077#1084' '#1074#1077#1097#1072#1085#1080#1103
  ClientHeight = 306
  ClientWidth = 739
  ...
  inherited pnlEdit: TPanel
    ...
    object edtName: TDBEditEh
      ...
      DynProps = <>
      EditButtons = <>
      EmptyDataInfo.Text = #1056#1077#1096#1077#1085#1080#1077' ('#1086#1073#1103#1079#1072#1090#1077#1083#1100#1085#1086#1077' '#1087#1086#1083#1077')'
      ShowHint = True
      TabOrder = 0
      Visible = True
    end
  ...
  object dsData: TpFIBDataSet
    UpdateSQL.Strings = (
        ...
        'execute procedure Objects_Iud(1, 54, :O_ID, :O_Name, :O_Descript' +
        'ion, '#39#39', 0, '#39#39')')
    DeleteSQL.Strings = (
      'execute procedure Objects_Iud(2, 54, :OLD_O_ID)')
    InsertSQL.Strings = (
      
        'execute procedure Objects_Iud(0, 54, :O_ID, :O_Name, :O_Descript' +
        'ion, '#39#39', 0, '#39#39')')
    RefreshSQL.Strings = (
      'select'
      '    o.O_ID'
