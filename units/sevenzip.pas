...
//******************************************************************************
  ...
  ['{BAA9D5DC-9FF4-4382-9BFD-EC9065BD0125}']
    ...
    procedure SetPassword(const password: UnicodeString); stdcall;
    procedure SetPropertie(const name: UnicodeString; value: OleVariant); stdcall;
    procedure SetClassId(const classid: TGUID);
    function GetClassId: TGUID;
    property ClassId: TGUID read GetClassId write SetClassId;
  end;
...
var
  ...
  procedure Traverse(const p: string);
  var
    f: TSearchRec;
    i: integer;
    item: T7zBatchItem;
...
procedure T7zOutArchive.SetPropertie(const name: UnicodeString; value: OleVariant);
var
  intf: ISetProperties;
  p: PWideChar;
begin
