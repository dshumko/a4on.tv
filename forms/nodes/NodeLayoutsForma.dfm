inherited NodeLayoutsForm: TNodeLayoutsForm
  Left = 381
  Top = 171
  Caption = #1050#1086#1084#1087#1086#1085#1086#1074#1082#1072' '#1091#1079#1083#1086#1074
  ClientHeight = 495
  ClientWidth = 762
  ...
  inherited dbGrid: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'O_NAME'
        Footers = <>
        Title.Caption = #1050#1086#1084#1087#1086#1085#1086#1074#1082#1072
  ...
  inherited pnlEdit: TPanel
    ...
    object dbmmoO_DESCRIPTION: TDBMemoEh
      ...
      DynProps = <>
      EditButtons = <>
      EmptyDataInfo.Text = #1054#1087#1080#1089#1072#1085#1080#1077' '#1082#1086#1084#1087#1086#1085#1086#1074#1082#1080
      ShowHint = True
      TabOrder = 1
      Visible = True
      WantReturns = True
  ...
  object dsFileType: TpFIBDataSet
    UpdateSQL.Strings = (
        ...
        'execute procedure Objects_Iud(1, 79, :O_ID, :O_Name, :O_Descript' +
        'ion, :O_DIMENSION, 0, :O_CHARFIELD)')
    DeleteSQL.Strings = (
      'execute procedure Objects_Iud(2, 79, :OLD_O_ID)')
    InsertSQL.Strings = (
      
        'execute procedure Objects_Iud(0, 79, :O_ID, :O_Name, :O_Descript' +
        'ion, :O_DIMENSION, 0, :O_CHARFIELD)')
    RefreshSQL.Strings = (
      'select'
      '    o.O_ID'
  ...
  object dsLayout: TpFIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      '  , Node_Id'
      '  , Srv_Type'
      '  , iif(Mat_Qnt = -1, null, Mat_Qnt) Mat_Qnt  '
      '  -- , iif(Cust_Qnt = -1, null, Cust_Qnt) Cust_Qnt '
      '  , Cust_Qnt'
      '  , Mat_Id_List'
      '  , Mat_Req'
      '  , Notice'
